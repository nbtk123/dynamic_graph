...
unsigned Graph_Node::Is_Edge_Exist(std::list<Graph_Edge *> *lst, Graph_Edge *edge) {
...
unsigned int Graph_Node::Add_Edge_If_Not_Exists(std::list<Graph_Edge *> *lst, Graph_Edge *edge) {
